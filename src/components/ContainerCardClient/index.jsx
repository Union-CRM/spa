...
import {LineGray, ButtonInactive, ButtonActive,BoardStyle, H1, Container, Header,
     Top, HowManySubjectList, Button, Line, Spans,Active  , HowManyActive,
      Inactive, HowManyInactive, SpanPosition, IconPosition, ContainerFather} from './styles'
